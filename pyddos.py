    ...
    def doconnection(self):
        ...
        while socks < int(self.threads):
            try:
                ...
                break
                sys.exit(cprint('[-] Canceled by user', 'red'))
        print(colored('I have sent ', 'green') + colored(str(self.pkt_count), 'cyan') + colored(
            ' packets successfully.Now i\'m going to sleep for ', 'green') + colored(self.sleep, 'red') + colored(
            ' second', 'green'))
